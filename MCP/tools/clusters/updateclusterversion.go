...
func UpdateclusterversionHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/clusters/%s/updates", cfg.BaseURL, name)
		...
		var result models.UpdateClusterVersionResponse
...
func CreateUpdateclusterversionTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_clusters_name_updates",
		...
		mcp.WithString("version", mcp.Required(), mcp.Description("Input parameter: The desired Kubernetes version following a successful update.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    UpdateclusterversionHandler(cfg),
	}
}
