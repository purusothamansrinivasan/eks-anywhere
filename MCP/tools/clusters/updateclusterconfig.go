...
func UpdateclusterconfigHandler(cfg *config.APIConfig) func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
	return func(ctx context.Context, request mcp.CallToolRequest) (*mcp.CallToolResult, error) {
		...
		url := fmt.Sprintf("%s/clusters/%s/update-config", cfg.BaseURL, name)
		...
		var result models.UpdateClusterConfigResponse
...
func CreateUpdateclusterconfigTool(cfg *config.APIConfig) models.Tool {
	tool := mcp.NewTool("post_clusters_name_update-config",
		...
		mcp.WithObject("resourcesVpcConfig", mcp.Description("Input parameter: An object representing the VPC configuration to use for an Amazon EKS cluster.")),
	)

	return models.Tool{
		Definition: tool,
		Handler:    UpdateclusterconfigHandler(cfg),
	}
}
