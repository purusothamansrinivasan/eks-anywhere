...
This MCP (Model Content Protocol) server provides access to Amazon Elastic Kubernetes Service API functionality through HTTP, HTTPS, and STDIO transport modes.
